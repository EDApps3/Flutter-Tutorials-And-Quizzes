...
class LoaderQ2 extends StatefulWidget {
  @override
  _LoaderQ2State createState() => new _LoaderQ2State();
}

class _LoaderQ2State extends State<LoaderQ2> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create Yellow SpinKitChasingDots Sized To 70 ",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="SpinKitChasingDots" && T2.text.trim()=="color" && T3.text.trim()=="size" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
