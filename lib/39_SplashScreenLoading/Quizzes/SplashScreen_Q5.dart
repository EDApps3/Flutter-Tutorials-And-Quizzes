...
class SplashScreenQ5 extends StatefulWidget {
  @override
  _SplashScreenQ5State createState() => new _SplashScreenQ5State();
}

class _SplashScreenQ5State extends State<SplashScreenQ5> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Make Splash Screen Having Image Home.png Sized To 200 ",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="photoSize" && T2.text.trim()=="200" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
