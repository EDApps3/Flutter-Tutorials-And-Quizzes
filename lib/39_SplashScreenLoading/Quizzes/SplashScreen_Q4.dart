...
class SplashScreenQ4 extends StatefulWidget {
  @override
  _SplashScreenQ4State createState() => new _SplashScreenQ4State();
}

class _SplashScreenQ4State extends State<SplashScreenQ4> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Make Splash Screen Having Stars.png As In Image",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="image" && T2.text.trim()=="asset" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
