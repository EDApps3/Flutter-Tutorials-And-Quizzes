...
class ToastQ4 extends StatefulWidget {
  @override
  _ToastQ4State createState() => new _ToastQ4State();
}

class _ToastQ4State extends State<ToastQ4> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Show A Toast Saying Hello When The Page Is Loaded Having Long Duration",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if( T1.text.trim()=='Toast' && T2.text.trim()=='show' && T3.text.trim()=='context' && T4.text.trim()=='duration' && T5.text.trim()=='LENGTH_LONG' ) {
                            TxtClr=Colors.green;
                            PlayWinSound();
