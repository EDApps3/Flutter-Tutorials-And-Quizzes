...
class ToastQ1 extends StatefulWidget {
  ToastQ1({Key key}) : super(key: key);
  @override
  _ToastQ1State createState() => _ToastQ1State();
}

class _ToastQ1State extends State<ToastQ1> {
              ...
              RadioListTile<ClrVal>(
                ...
                onChanged: (ClrVal value) {
                  setState(() {
                    ...
                    Result="Wrong Answer";
                    TxtClr=Colors.red;
                    TxtSol="Toast Is An Popup Message That Show For The User For A Duration";
                    testAlert(context);
                    _character=null;
                  });
                },
