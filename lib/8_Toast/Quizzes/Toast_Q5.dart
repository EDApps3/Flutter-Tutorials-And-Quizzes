...
class ToastQ5 extends StatefulWidget {
  @override
  _ToastQ5State createState() => new _ToastQ5State();
}

class _ToastQ5State extends State<ToastQ5> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Show A Toast Saying Hello When The Page Is Loaded Positioned At The Top",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if( T1.text.trim()=='Toast' && T2.text.trim()=='show' && T3.text.trim()=='context' && T4.text.trim()=='gravity' && T5.text.trim()=='TOP' ) {
                            TxtClr=Colors.green;
                            PlayWinSound();
