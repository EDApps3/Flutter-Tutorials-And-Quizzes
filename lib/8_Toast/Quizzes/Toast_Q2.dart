...
class ToastQ2 extends StatefulWidget {
  @override
  _ToastQ2State createState() => new _ToastQ2State();
}

class _ToastQ2State extends State<ToastQ2> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Show A Toast Saying Hello When The Page Is Loaded:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if( T1.text.trim()=='Toast' && T2.text.trim()=='show' && T3.text.trim()=='context' ) {
                            TxtClr=Colors.green;
                            PlayWinSound();
