...
class ToastQ3 extends StatefulWidget {
  @override
  _ToastQ3State createState() => new _ToastQ3State();
}

class _ToastQ3State extends State<ToastQ3> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Show A Toast Saying Hello When The Page Is Loaded Having Short Duration",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if( T1.text.trim()=='Toast' && T2.text.trim()=='show' && T3.text.trim()=='context' && T4.text.trim()=='duration' && T5.text.trim()=='LENGTH_SHORT' ) {
                            TxtClr=Colors.green;
                            PlayWinSound();
