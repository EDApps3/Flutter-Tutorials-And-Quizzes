...
class ToastQ6 extends StatefulWidget {
  @override
  _ToastQ6State createState() => new _ToastQ6State();
}

class _ToastQ6State extends State<ToastQ6> {
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if( T1.text.trim()=='Toast' && T2.text.trim()=='show' && T3.text.trim()=='context' && T4.text.trim()=='gravity' && T5.text.trim()=='CENTER' ) {
                            TxtClr=Colors.green;
                            PlayWinSound();
