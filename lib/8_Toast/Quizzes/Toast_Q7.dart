...
class ToastQ7 extends StatefulWidget {
  @override
  _ToastQ7State createState() => new _ToastQ7State();
}

class _ToastQ7State extends State<ToastQ7> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Show A Toast Saying Hello When The Page Is Loaded Positioned At The Center",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if( T1.text.trim()=='Toast' && T2.text.trim()=='show' && T3.text.trim()=='context' && T4.text.trim()=='gravity' && T5.text.trim()=='BOTTOM' ) {
                            TxtClr=Colors.green;
                            PlayWinSound();
