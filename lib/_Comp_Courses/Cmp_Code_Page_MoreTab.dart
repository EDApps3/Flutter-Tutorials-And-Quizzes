...
var Public_RunCodeRout,Public_CodeRoute,Public_ItemList,Public_ToDo,Pub_Exp,PubOfDocList,Public_MoreTabCodeRoute;


class CmpCodePageMoreTab extends StatefulWidget {
  var Title,BackRoute,NextRoute,CodeRoute,ToDo,TxtExplanation;
  final List ItemList;
  final Icon TabIcon;
  var RunCodeRoute;
  var OffDocList;
  var MoreTabCodeRoute;
  ...
  CmpCodePageMoreTab({
    ...
    @required this.MoreTabCodeRoute,
  });

  @override
  _CmpCodePageMoreTabState createState() => new _CmpCodePageMoreTabState();
}

class _CmpCodePageMoreTabState extends State<CmpCodePageMoreTab> with SingleTickerProviderStateMixin {
  ...
  Future initState()  {
    ...
    Public_MoreTabCodeRoute=widget.MoreTabCodeRoute;
      ...
      appBar: new AppBar(
        ...
        bottom: new TabBar(
          ...
          tabs: [
            ...
            Tab(icon: Icon(Icons.code,),text:"Code 1"),
            Tab(icon: Icon(Icons.code,),text:"Code 2"),
...
class CodeView2 extends StatefulWidget {
  @override
  CodeView2State createState() => new CodeView2State();
}
class CodeView2State extends State<CodeView2> with AutomaticKeepAliveClientMixin {

  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor:(ThemeResult=="Light")?Colors.white:CardBg.withBlue(255).withGreen(255).withRed(255),
        body:EditedSourceCodeView(
          filePath:Public_MoreTabCodeRoute,
        ),
    );
  }
