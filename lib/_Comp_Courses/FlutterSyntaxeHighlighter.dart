...
class EditedSyntaxHighlighterStyle {
  EditedSyntaxHighlighterStyle(
      {this.baseStyle,
        this.numberStyle,
        this.commentStyle,
        this.keywordStyle,
  ...
  static EditedSyntaxHighlighterStyle lightThemeStyle() {
    return EditedSyntaxHighlighterStyle(
  ...
  static EditedSyntaxHighlighterStyle darkThemeStyle() {
    return EditedSyntaxHighlighterStyle(
...
class DartSyntaxHighlighter extends SyntaxHighlighter {
  DartSyntaxHighlighter([this._style]) {
    ...
    _style ??= EditedSyntaxHighlighterStyle.darkThemeStyle();
  }

  EditedSyntaxHighlighterStyle _style;
...
class _HighlightSpan {
  ...
  TextStyle textStyle(EditedSyntaxHighlighterStyle style) {
