...
import 'Switch_GenerateQuizzes.dart';
...
class SwitchQ1 extends StatefulWidget {
  @override
  _SwitchQ1State createState() => new _SwitchQ1State();
}

class _SwitchQ1State extends State<SwitchQ1> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A SnackBar Having Hello As A Text",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="SnackBar" && T2.text.trim()=="content" && T3.text.trim()=="showSnackBar"  ){
                            TxtClr=Colors.green;
                            PlayWinSound();
