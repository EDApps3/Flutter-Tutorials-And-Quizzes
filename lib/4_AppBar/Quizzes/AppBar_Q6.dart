...
class AppBarQ6 extends StatefulWidget {
  @override
  _AppBarQ6State createState() => new _AppBarQ6State();
}

class _AppBarQ6State extends State<AppBarQ6> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Left Icon(ac_unit) In The Left Side Of The AppBar:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="leading" && T2.text.trim()=="Icons" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
