...
class FlexQ1 extends StatefulWidget {
  @override
  _FlexQ1State createState() => new _FlexQ1State();
}

class _FlexQ1State extends State<FlexQ1> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Simple Row Having Second Image Flexed By 3:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="Expanded" && T2.text.trim()=="flex" && T3.text.trim()=="3"){
                            TxtClr=Colors.green;
                            PlayWinSound();
