...
class DialogsQ1 extends StatefulWidget {
  @override
  _DialogsQ1State createState() => new _DialogsQ1State();
}

class _DialogsQ1State extends State<DialogsQ1> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create An Dialog Having Hello As A Content:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="content" && T2.text.trim()=="Text" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
