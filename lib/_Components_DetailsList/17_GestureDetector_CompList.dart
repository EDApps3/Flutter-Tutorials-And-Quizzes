...
String GestureDetector_BodyDoubleTap_Explanation=
    "-main is a principal method called once the program is loaded\n\n"
    "-Once Program Is Loaded runApp Will Run And Call Our Class That We Created(BodyDoubleTap) To Be Runned\n\n"
    "-This Class Is Stateless Widget As There Is No Data Change When Page Is Loaded (No State Change)\n\n"
    "-As Flutter is Based On Widget A Widget must be Builded\n\n"
    "-Creating An Material App That Hold the Title Of The App That Show When We Need To Close It\n\n"
    "-As An Home It Has Scaffold\n\n"
    "-Scaffold Allow Us To Use AppBar And Set The Body Of The Page\n\n"
    "-As An AppBar It Has An Title\n\n"
    "-As An Body It Take A Container Globed With GestureDetector\n\n"
    "-Container Having Max Width And Height That Fit 100% The Body With White BackgroundColor\n\n"
    "-Once The Container DoubleTapped An Dialog Is Popped Up!\n\n";


List GestureDetector_BodyDoubleTap_list =[
  SizedBox(height:5,),
  Container (
    padding: new EdgeInsets.only(bottom: 20.0),
    child:
    new Card(
      child: new Container(
        ...
        child: new Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              CmpTitle(Title:"Body DoubleTap Detector:",),
              Divider(),
              CmpSubTitle(SubTitle:"Applying Gesture Detector Double Tap On Body",),
            ]
        ),
      ),
    ),
