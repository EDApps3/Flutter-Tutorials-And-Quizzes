...
var ApkAdminGlobal =ListTile(
    ...
    onTap:(){
      ...
      CmpWebViewPage(
        Title:"Apk Admin",
        GoUrl:"https://pub.dev/packages/apk_admin",
      )
      );
    },
);

List ApkAdmin_OffDoc=[
  SizedBox(height:10),
  ApkAdminGlobal,
];
    ...
    new Card(
      child: new Container(
        ...
        child: new Column(
            ...
            children: <Widget>[
              CmpTitle(Title:"What Is ApkAdmin?",),
              Divider(),
              CmpSubTitle(SubTitle:"A Flutter plugin for launching, installing from backup, uninstalling and sharing android apps and more.\n",),
            ]
        ),
      ),
    ),
      ...
      child: new Container(
        ...
        child: new Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 16,),
              Image.asset("Images/ApkAdmin.PNG",),
