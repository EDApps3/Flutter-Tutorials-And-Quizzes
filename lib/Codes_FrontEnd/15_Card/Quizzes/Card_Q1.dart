...
class CardQ1 extends StatefulWidget {
  @override
  _CardQ1State createState() => new _CardQ1State();
}

class _CardQ1State extends State<CardQ1> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Field To Set Card Text To Hi:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="Card" && T2.text.trim()=="Text" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
