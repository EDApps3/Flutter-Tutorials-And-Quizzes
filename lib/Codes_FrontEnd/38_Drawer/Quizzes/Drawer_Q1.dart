...
class DrawerQ1 extends StatefulWidget {
  @override
  _DrawerQ1State createState() => new _DrawerQ1State();
}

class _DrawerQ1State extends State<DrawerQ1> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Simple Left Drawer Menu",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="drawer" && T2.text.trim()=="Drawer"){
                            TxtClr=Colors.green;
                            PlayWinSound();
