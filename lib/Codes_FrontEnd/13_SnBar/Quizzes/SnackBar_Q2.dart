...
class SnackBarQ2 extends StatefulWidget {
  @override
  _SnackBarQ2State createState() => new _SnackBarQ2State();
}

class _SnackBarQ2State extends State<SnackBarQ2> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Red SnackBar:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="SnackBar" && T2.text.trim()=="content" && T3.text.trim()=="showSnackBar" && T4.text.trim()=="backgroundColor" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
