...
class SimpleLoaderQ1 extends StatefulWidget {
  @override
  _SimpleLoaderQ1State createState() => new _SimpleLoaderQ1State();
}

class _SimpleLoaderQ1State extends State<SimpleLoaderQ1> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Linear Progress Indicator Having Bg Color Red,Active Value Color yellow",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="LinearProgressIndicator" && T2.text.trim()=="backgroundColor" && T3.text.trim()=="valueColor"  ){
                            TxtClr=Colors.green;
                            PlayWinSound();
