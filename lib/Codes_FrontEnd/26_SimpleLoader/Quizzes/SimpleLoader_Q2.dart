...
class SimpleLoaderQ2 extends StatefulWidget {
  @override
  _SimpleLoaderQ2State createState() => new _SimpleLoaderQ2State();
}

class _SimpleLoaderQ2State extends State<SimpleLoaderQ2> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Linear Progress Indicator Having Bg Color yellow,Active Value Color green",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="LinearProgressIndicator" && T2.text.trim()=="yellow" && T3.text.trim()=="green"  ){
                            TxtClr=Colors.green;
                            PlayWinSound();
