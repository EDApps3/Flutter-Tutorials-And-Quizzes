...
import 'Flex_GenerateQuizzes.dart';
...
class FlexQ2 extends StatefulWidget {
  @override
  _FlexQ2State createState() => new _FlexQ2State();
}

class _FlexQ2State extends State<FlexQ2> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Simple Row while Second Divider Flexed By 4:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="Expanded" && T2.text.trim()=="flex" && T3.text.trim()=="4" && T4.text.trim()=="Divider"){
                            TxtClr=Colors.green;
                            PlayWinSound();
