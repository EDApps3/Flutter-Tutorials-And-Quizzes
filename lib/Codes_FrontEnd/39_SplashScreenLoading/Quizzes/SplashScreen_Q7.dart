...
class SplashScreenQ7 extends StatefulWidget {
  @override
  _SplashScreenQ7State createState() => new _SplashScreenQ7State();
}

class _SplashScreenQ7State extends State<SplashScreenQ7> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Make Splash Screen Having loader Color Set To Red",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="loaderColor" && T2.text.trim()=="Colors" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
