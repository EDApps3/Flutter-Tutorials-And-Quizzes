...
class SplashScreenQ6 extends StatefulWidget {
  @override
  _SplashScreenQ6State createState() => new _SplashScreenQ6State();
}

class _SplashScreenQ6State extends State<SplashScreenQ6> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Make Splash Screen Having BackGroundColor Set To Yellow ",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="backgroundColor" && T2.text.trim()=="Colors" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
