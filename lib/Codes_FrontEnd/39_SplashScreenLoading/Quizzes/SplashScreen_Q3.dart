...
class SplashScreenQ3 extends StatefulWidget {
  @override
  _SplashScreenQ3State createState() => new _SplashScreenQ3State();
}

class _SplashScreenQ3State extends State<SplashScreenQ3> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Make Splash Screen Having As A Main Title Demo",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="title" && T2.text.trim()=="Text" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
