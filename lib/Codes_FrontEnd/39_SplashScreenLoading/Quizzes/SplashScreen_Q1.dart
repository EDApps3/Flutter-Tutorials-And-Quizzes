...
class SplashScreenQ1 extends StatefulWidget {
  @override
  _SplashScreenQ1State createState() => new _SplashScreenQ1State();
}

class _SplashScreenQ1State extends State<SplashScreenQ1> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Make Splash Screen Rest For 6 Seconds:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="SplashScreen" && T2.text.trim()=="seconds" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
