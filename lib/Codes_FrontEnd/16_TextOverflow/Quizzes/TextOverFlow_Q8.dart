...
class TextOverFlowQ8 extends StatefulWidget {
  @override
  _TextOverFlowQ8State createState() => new _TextOverFlowQ8State();
}

class _TextOverFlowQ8State extends State<TextOverFlowQ8> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Turn Text OverFlow To Faded:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="Text" && T2.text.trim()=="overflow"  && T3.text.trim()=="TextOverflow" && T4.text.trim()=="visible"  ){
                            TxtClr=Colors.green;
                            PlayWinSound();
