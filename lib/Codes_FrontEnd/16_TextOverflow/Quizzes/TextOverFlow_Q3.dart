...
class TextOverFlowQ3 extends StatefulWidget {
  TextOverFlowQ3({Key key}) : super(key: key);
  @override
  _TextOverFlowQ3State createState() => _TextOverFlowQ3State();
}

class _TextOverFlowQ3State extends State<TextOverFlowQ3> {
              ...
              RadioListTile<ClrVal>(
                ...
                onChanged: (ClrVal value) {
                  setState(() {
                    ...
                    Result="Wrong Answer";
                    TxtClr=Colors.red;
                    TxtSol="Text OverFlowed Show As Transparent";
                    testAlert(context);
                    _character=null;
                  });
                },
