...
class TextOverFlowQ7 extends StatefulWidget {
  @override
  _TextOverFlowQ7State createState() => new _TextOverFlowQ7State();
}

class _TextOverFlowQ7State extends State<TextOverFlowQ7> {
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="Text" && T2.text.trim()=="overflow"  && T3.text.trim()=="TextOverflow" && T4.text.trim()=="fade"  ){
                            TxtClr=Colors.green;
                            PlayWinSound();
