...
class TextOverFlowQ4 extends StatefulWidget {
  TextOverFlowQ4({Key key}) : super(key: key);
  @override
  _TextOverFlowQ4State createState() => _TextOverFlowQ4State();
}

class _TextOverFlowQ4State extends State<TextOverFlowQ4> {
              ...
              RadioListTile<ClrVal>(
                ...
                onChanged: (ClrVal value) {
                  setState(() {
                    ...
                    Result="Wrong Answer";
                    TxtClr=Colors.red;
                    TxtSol="Text Rendered Outside Its Container";
                    testAlert(context);
                    _character=null;
                  });
                },
