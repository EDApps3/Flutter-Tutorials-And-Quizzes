...
class SliderQ2 extends StatefulWidget {
  @override
  _SliderQ2State createState() => new _SliderQ2State();
}

class _SliderQ2State extends State<SliderQ2> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Obtain Slidable Slider Having As An Active Color Yellow, Inactive Color Grey",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="Slider" && T2.text.trim()=="value"  && T3.text.trim()=="onChanged" && T4.text.trim()=="activeColor" && T5.text.trim()=="inactiveColor" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
