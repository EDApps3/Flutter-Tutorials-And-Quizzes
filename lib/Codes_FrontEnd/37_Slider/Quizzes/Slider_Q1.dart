...
class SliderQ1 extends StatefulWidget {
  @override
  _SliderQ1State createState() => new _SliderQ1State();
}

class _SliderQ1State extends State<SliderQ1> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Obtain Slidable Slider:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="Slider" && T2.text.trim()=="value"  && T3.text.trim()=="onChanged" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
