...
class LayoutQ2 extends StatefulWidget {
  LayoutQ2({Key key}) : super(key: key);
  @override
  _LayoutQ2State createState() => _LayoutQ2State();
}

class _LayoutQ2State extends State<LayoutQ2> {
        ...
        body:Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              SizedBox(height: 30,),
              Text(
                "In Row Layout,Cross Axis Used To Align:",
              ),
              RadioListTile<ClrVal>(
                ...
                onChanged: (ClrVal value) {
                  setState(() {
                    ...
                    Result="Wrong Answer";
                    TxtClr=Colors.red;
                    TxtSol="In Row Layout,Main Axis Used To Align Vertically";
                    testAlert(context);
                    _character=null;
                  });
                },
