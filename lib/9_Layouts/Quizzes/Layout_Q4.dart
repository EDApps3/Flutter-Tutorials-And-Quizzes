...
class LayoutQ4 extends StatefulWidget {
  LayoutQ4({Key key}) : super(key: key);
  @override
  _LayoutQ4State createState() => _LayoutQ4State();
}

class _LayoutQ4State extends State<LayoutQ4> {
        ...
        body:Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              SizedBox(height: 30,),
              Text(
                "In Column Layout,Main Axis Used To Align:",
              ),
              RadioListTile<ClrVal>(
                ...
                onChanged: (ClrVal value) {
                  setState(() {
                    ...
                    TxtClr=Colors.green;
                    TxtSol="In Column Layout,Main Axis Used To Align Vertically";
                    testAlert(context);
                    _character=null;
                  });
                },
