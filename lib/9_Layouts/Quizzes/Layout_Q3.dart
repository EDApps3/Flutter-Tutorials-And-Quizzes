...
class LayoutQ3 extends StatefulWidget {
  LayoutQ3({Key key}) : super(key: key);
  @override
  _LayoutQ3State createState() => _LayoutQ3State();
}

class _LayoutQ3State extends State<LayoutQ3> {
        ...
        body:Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              SizedBox(height: 30,),
              Text(
                "In Column Layout,Cross Axis Used To Align:",
              ),
              RadioListTile<ClrVal>(
                ...
                onChanged: (ClrVal value) {
                  setState(() {
                    ...
                    TxtClr=Colors.green;
                    TxtSol="In Column Layout,Cross Axis Used To Align Horizontally";
                    testAlert(context);
                    _character=null;
                  });
                },
