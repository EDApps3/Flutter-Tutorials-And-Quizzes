...
class DrawerQ2 extends StatefulWidget {
  @override
  _DrawerQ2State createState() => new _DrawerQ2State();
}

class _DrawerQ2State extends State<DrawerQ2> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Simple Right Drawer Menu",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="endDrawer" && T2.text.trim()=="Drawer"){
                            TxtClr=Colors.green;
                            PlayWinSound();
