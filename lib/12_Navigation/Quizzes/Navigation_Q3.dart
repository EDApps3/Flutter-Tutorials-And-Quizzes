...
class NavigationQ3 extends StatefulWidget {
  @override
  _NavigationQ3State createState() => new _NavigationQ3State();
}

class _NavigationQ3State extends State<NavigationQ3> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Call The Following Number:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="tel" && T2.text.trim()=="canLaunch" && T3.text.trim()=="launch"  ){
                            TxtClr=Colors.green;
                            PlayWinSound();
