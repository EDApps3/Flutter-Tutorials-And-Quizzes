...
String TxtSol="Answer Is:\n\n"
    "_launchUrl() async{\n"
    " const Mail='mailto:edapps@gmail.com';\n"
...
class NavigationQ5 extends StatefulWidget {
  @override
  _NavigationQ5State createState() => new _NavigationQ5State();
}

class _NavigationQ5State extends State<NavigationQ5> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Send Email To The Following Email:",
                      style: TextStyle(
                          fontSize: 16,
