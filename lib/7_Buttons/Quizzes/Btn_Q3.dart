...
class BtnQ3 extends StatefulWidget {
  @override
  _BtnQ3State createState() => new _BtnQ3State();
}

class _BtnQ3State extends State<BtnQ3> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Rounded Circular Raised Button By 30.0",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="shape" && T2.text.trim()=="borderRadius" && T3.text.trim()=="circular" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
