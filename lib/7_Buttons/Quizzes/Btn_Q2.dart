...
class BtnQ2 extends StatefulWidget {
  @override
  _BtnQ2State createState() => new _BtnQ2State();
}

class _BtnQ2State extends State<BtnQ2> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Full Width Raised Button Having As Value FullWidthButton",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="width" && T2.text.trim()=="RaisedButton" && T3.text.trim()=="Text" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
