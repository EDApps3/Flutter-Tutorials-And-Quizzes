...
class BtnQ1 extends StatefulWidget {
  @override
  _BtnQ1State createState() => new _BtnQ1State();
}

class _BtnQ1State extends State<BtnQ1> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Raised Button Having As Value HitMe",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="RaisedButton" && T2.text.trim()=="Text" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
