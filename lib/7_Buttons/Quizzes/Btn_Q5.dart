...
class BtnQ5 extends StatefulWidget {
  @override
  _BtnQ5State createState() => new _BtnQ5State();
}

class _BtnQ5State extends State<BtnQ5> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Clipped IconButton Having An Android Icon",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="ClipOval" && T2.text.trim()=="IconButton" && T3.text.trim()=="icon" && T4.text.trim()=="Icon" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
