...
class BtnQ6 extends StatefulWidget {
  @override
  _BtnQ6State createState() => new _BtnQ6State();
}

class _BtnQ6State extends State<BtnQ6> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Flat Button Having As Value FlatButton",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="FlatButton" && T2.text.trim()=="Text" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
