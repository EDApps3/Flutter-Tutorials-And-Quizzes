...
class CardQ4 extends StatefulWidget {
  @override
  _CardQ4State createState() => new _CardQ4State();
}

class _CardQ4State extends State<CardQ4> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Field To Set Card Elevated To 20:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="Card" && T2.text.trim()=="elevation" && T3.text.trim()=="20" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
