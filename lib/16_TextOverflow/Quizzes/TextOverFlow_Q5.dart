...
class TextOverFlowQ5 extends StatefulWidget {
  @override
  _TextOverFlowQ5State createState() => new _TextOverFlowQ5State();
}

class _TextOverFlowQ5State extends State<TextOverFlowQ5> {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Turn Text Clip OverFlowed:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="Text" && T2.text.trim()=="overflow"  && T3.text.trim()=="TextOverflow" && T4.text.trim()=="clip"  ){
                            TxtClr=Colors.green;
                            PlayWinSound();
