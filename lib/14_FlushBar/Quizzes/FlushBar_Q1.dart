...
import 'FlushBar_GenerateQuizzes.dart';
...
class FlushBarQ1 extends StatefulWidget {
  @override
  _FlushBarQ1State createState() => new _FlushBarQ1State();
}

class _FlushBarQ1State extends State<FlushBarQ1> {
              ...
              SizedBox(
                  ...
                  RaisedButton(
                    ...
                    onPressed: (){
                      ...
                      if(RandQuizz==false){
                        Generate_FlushBar_Quiz(context);
                      }
                      else{
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 30,),
                    Text(
                      "Fill The Missing Fields To Create A Simple FlushBar Having Welcome As An Title,And User As A Message:",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="FlushBar" && T2.text.trim()=="title" && T3.text.trim()=="message"){
                            TxtClr=Colors.green;
                            PlayWinSound();
