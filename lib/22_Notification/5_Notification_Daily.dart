...
class DailyNotif extends StatefulWidget {
  @override
  _DailyNotifState createState() => _DailyNotifState();
}

class _DailyNotifState extends State<DailyNotif> {
  Future<void> InitializeNot() async {
