...
class SnackBarQ3 extends StatefulWidget {
  @override
  _SnackBarQ3State createState() => new _SnackBarQ3State();
}

class _SnackBarQ3State extends State<SnackBarQ3> {
                    ...
                    SizedBox(
                      ...
                      child:RaisedButton(
                        ...
                        onPressed: (){
                          ...
                          if(T1.text.trim()=="SnackBar" && T2.text.trim()=="content" && T3.text.trim()=="showSnackBar" && T4.text.trim()=="duration" ){
                            TxtClr=Colors.green;
                            PlayWinSound();
